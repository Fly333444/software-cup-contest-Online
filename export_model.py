# -*- coding: utf-8 -*-
"""Export trained PicoDet model to Paddle Inference format with combined params.
...
def main():
    ...
    config_path = os.path.join(BASE_DIR, "configs", "picodet_m_fire_200e.yml")
    ...
    # trainer.export creates a subdirectory named after the config; move files up
    import shutil
    subdir = os.path.join(output_dir, "picodet_m_fire_200e")
